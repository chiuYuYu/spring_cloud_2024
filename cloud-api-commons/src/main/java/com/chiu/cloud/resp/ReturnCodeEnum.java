...
public enum ReturnCodeEnum {
    ...
    public static void main(String[] args) {
        System.out.println(getReturnCodeEnumV2("375"));
        System.out.println(getReturnCodeEnumV2("375").getCode());
        System.out.println(getReturnCodeEnumV2("375").getMessage());
    }
}
